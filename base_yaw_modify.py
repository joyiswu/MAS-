...
class arm_base_printing:
    def __init__(self):
        ...
        initial_plan = self.move_to_initial((3,1,0.2))

        for position in initial_plan.joint_trajectory.points:
            print(position.positions[2])
        # print(point_list_ob)
    ...
    def printing_visualize(self, start_point, end_point):
        ...
        box_pose.pose.position.z = (end_point[2] + start_point[2]) / 2.000000 - 0.01
